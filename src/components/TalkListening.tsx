    ...
    return (
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg p-8 sm:p-10">
          ...
          {/* Per-talk breakdown */}
          <div className="mb-8">
            <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-3">トーク別スコア</h3>
              ...
              {talks.map((talk, ti) => {
                ...
                return (
                  <div key={talk.id} className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-300 inline-flex items-center gap-2">
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-bold rounded-full bg-purple-100 text-purple-700 border border-purple-200 dark:bg-purple-900/40 dark:text-purple-300 dark:border-purple-800">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg p-6 sm:p-8 mb-4">
        ...
        {playing && (
          <div className="mb-4 p-3 rounded-xl bg-indigo-50 border border-indigo-100 dark:bg-indigo-900/40 dark:border-indigo-800 animate-pulse">
            <span className="text-sm font-semibold text-indigo-700 dark:text-indigo-300">Playing...</span>
          </div>
        )}
              ...
              {currentQ.options.map((option, index) => {
                ...
                if (answered) {
                  if (index === currentQ.correctIndex) {
                    optionStyle =
                      'bg-green-50 border-green-400 text-green-800 ring-2 ring-green-300 dark:bg-green-900/40 dark:border-green-700 dark:text-green-300 dark:ring-green-700';
                  } else if (index === selectedIndex && index !== currentQ.correctIndex) {
                    optionStyle = 'bg-red-50 border-red-400 text-red-800 ring-2 ring-red-300 dark:bg-red-900/40 dark:border-red-700 dark:text-red-300 dark:ring-red-700';
                  } else {
