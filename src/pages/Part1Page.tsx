...
import Part1Listening from '../components/Part1Listening';
...
export default function Part1Page() {
  ...
  if (setId) {
    const set = part1Sets.find((s) => s.id === setId);
    ...
    return (
      <div>
        ...
        {/* Quiz */}
        <Part1Listening questions={set.questions} />
  ...
  return (
    <div>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">TOEIC Part 1 - 写真描写問題</p>
        <p className="mt-3 text-gray-500 dark:text-gray-400 max-w-md mx-auto text-sm leading-relaxed">
          場面の説明を読み、4つの英語の描写を聞いて、正しいものを選びましょう。実際のTOEICでは写真が表示されますが、ここでは場面を日本語で説明します。
        </p>
      </div>
